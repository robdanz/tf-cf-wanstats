...
| D1 gap tracking (`gap_buckets`) | 180 days | One row per 5-min bucket with no data in any direction; retried at +0/+1h/+6h/+24h/+72h after discovery, then confirmed empty and kept as a record |
