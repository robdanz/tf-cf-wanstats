...
const STATEMENTS = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_tmh_direction_ts ON tunnel_metrics_hourly (direction, ts)`,
  `CREATE INDEX IF NOT EXISTS idx_tmh_tunnel_direction_ts ON tunnel_metrics_hourly (tunnel_name, direction, ts)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_tmd_direction_ts ON tunnel_metrics_daily (direction, ts)`,
  `CREATE INDEX IF NOT EXISTS idx_tmd_tunnel_direction_ts ON tunnel_metrics_daily (tunnel_name, direction, ts)`,
