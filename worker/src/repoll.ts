...
import { storeTunnelMetrics, rollupHour, rollupDay, getMetadata, setMetadata } from './d1';
...
// and daily rollups are rewritten. Two delays: 14h catches the age-based
...
// same hour. Rows the source dropped are kept (nothing is ever deleted).
